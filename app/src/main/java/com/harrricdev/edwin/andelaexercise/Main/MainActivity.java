...
import com.harrricdev.edwin.andelaexercise.Utils.ActivityUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Andela Learning Exercise");
        ...
        mainPresenter = new MainPresenterImpl(mainFragment);
